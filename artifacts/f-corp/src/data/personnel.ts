...
// 100 fictional last names
const LAST_NAMES = [
  'Верди', 'Кастро', 'Нильсен', 'Ковач', 'Браун', 'Попеску', 'Мартин', 'Хансен', 'Диас', 'Ромеро',
  'Петров', 'Силва', 'Мюллер', 'Бенитес', 'Круз', 'Туран', 'Лопес', 'Кос', 'Вагнер', 'Жупан',
  'Алиев', 'Бекер', 'Кортес', 'Домбро', 'Эрмес', 'Фонсека', 'Гонсало', 'Херо', 'Ибраев', 'Янков',
  'Клинт', 'Ламар', 'Монако', 'Надаль', 'Олсен', 'Перейра', 'Кирос', 'Родрик', 'Сабо', 'Торрес',
  'Уэльс', 'Васко', 'Вебер', 'Хаим', 'Яго', 'Зурко', 'Аги', 'Балла', 'Чаве', 'Делор',
  'Энсо', 'Фавр', 'Габри', 'Хека', 'Ибо', 'Жорда', 'Карра', 'Лода', 'Маси', 'Нова',
  'Орен', 'Перо', 'Ракич', 'Соза', 'Тота', 'Уран', 'Вала', 'Вески', 'Ксано', 'Яромир',
  'Зима', 'Анко', 'Бола', 'Цана', 'Дора', 'Эрен', 'Флора', 'Гари', 'Хело', 'Ибас',
  'Жено', 'Кива', 'Лора', 'Мора', 'Нора', 'Ора', 'Пара', 'Рика', 'Сора', 'Тура',
  'Ура', 'Вора', 'Вика', 'Ксара', 'Яра', 'Зора', 'Амба', 'Бренк', 'Чоло', 'Дакс',
];
