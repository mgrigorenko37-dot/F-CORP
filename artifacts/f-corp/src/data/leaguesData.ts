  ...
  'Испания': {
    ...
    leagues: [
      { level: 1, name: 'La Liga', totalClubs: 20, promoted: 0, relegated: 3,
        rivals: ['Real Alteza', 'Deportivo Solana', 'Atlético Navarro', 'CD Meridian', 'Real Pontal', 'CF Valentora', 'Vilacosta'] },
      ...
      { level: 4, name: 'Segunda RFEF', totalClubs: 90, promoted: 2, relegated: 0,
        rivals: ['Deportiva Peña', 'CF Monforín', 'CD Xerondo', 'CD Mesetano', 'CD Alcobano', 'UD Lograda', 'CD Alcazarín'] },
    ],
  },
  ...
  'Германия': {
    ...
    leagues: [
      { level: 1, name: 'Bundesliga', totalClubs: 18, promoted: 0, relegated: 3,
        rivals: ['FC Weissberg', 'TSV Kronaufeld', 'VfL Waldeck', 'RB Nordtal', 'Eintracht Halfeld', 'VfL Grünberg', 'SC Felsenburg'] },
      { level: 2, name: '2. Bundesliga', totalClubs: 18, promoted: 3, relegated: 3,
        rivals: ['FC Nordhafen', 'FC Hannfeld', 'Fortuna Rheintal', 'Kaisermark', 'FC Nürntal', 'SC Gelsenfeld', 'FC Markauen'] },
      { level: 3, name: '3. Liga', totalClubs: 20, promoted: 3, relegated: 4,
        rivals: ['VfL Brückberg', 'SC Westfalia', 'SC Lerchen', 'SpVgg Unterholt', 'Wehen Rüssbach', 'FC Erztal', 'Ingolmark'] },
      { level: 4, name: 'Regionalliga', totalClubs: 18, promoted: 2, relegated: 0,
        rivals: ['FC Deisbach', 'SV Drochberg', 'TuS Kobwald', 'Hombrecht', 'Wormatia Waldau', 'SV Grünthal', 'FC Bergheim'] },
    ],
  },
  ...
  'Италия': {
    ...
    leagues: [
      { level: 1, name: 'Serie A', totalClubs: 20, promoted: 0, relegated: 3,
        rivals: ['Ausonion FC', 'Metronis AC', 'Torinolo FC', 'Vesuvion FC', 'Capitolion AS', 'Aquilion CF', 'Fioranzo'] },
      { level: 2, name: 'Serie B', totalClubs: 20, promoted: 3, relegated: 4,
        rivals: ['Parmola', 'Palerino', 'Catanzaro Unito', 'Crema FC', 'Barino', 'Samponia', 'Ligurion FC'] },
  ...
  'Франция': {
    ...
    leagues: [
      { level: 1, name: 'Ligue 1', totalClubs: 18, promoted: 0, relegated: 3,
        rivals: ['Parisien FC', 'Côte d\'Azuron', 'Rhodanion FC', 'Provençalon', 'Lilloix', 'OGC Nizio', 'Rennais FC'] },
      { level: 2, name: 'Ligue 2', totalClubs: 20, promoted: 3, relegated: 3,
        rivals: ['Auxeron', 'FC Metzen', 'Caennais', 'Grenoble Sud', 'Guingon', 'Amienois', 'Île-de-Franceon'] },
      { level: 3, name: 'National', totalClubs: 18, promoted: 2, relegated: 4,
        rivals: ['Sètelan', 'Dunkerton', 'Lavallo', 'Étoile Dorée', 'Villefranch', 'Nîmois', 'Concarnois'] },
  ...
  'Португалия': {
    ...
    leagues: [
      { level: 1, name: 'Primeira Liga', totalClubs: 18, promoted: 0, relegated: 3,
        rivals: ['Lusitânion', 'Atlanticon FC', 'Verdanion SC', 'Minhonão', 'Vitória SC Norte', 'Estorel', 'Famalense'] },
      ...
      { level: 3, name: 'Liga 3', totalClubs: 24, promoted: 3, relegated: 4,
        rivals: ['Alverça FC', 'Covinha', 'Oliveirola', 'Mafrense', 'Valadares Norte', 'Mariense FC', 'Tourizol'] },
      { level: 4, name: 'Campeonato de Portugal', totalClubs: 48, promoted: 2, relegated: 0,
        rivals: ['FC Gafanhão', 'Anadio', 'AD Fafense', 'FC Dourino', 'Lusitolense', 'Marinholense', 'Pombalense'] },
    ],
  },
  ...
  'Нидерланды': {
    ...
    leagues: [
      { level: 1, name: 'Eredivisie', totalClubs: 18, promoted: 0, relegated: 3,
        rivals: ['Amstellon FC', 'Eindhovon FC', 'Rottelon FC', 'Alkmarion FC', 'FC Utrechten', 'Twention FC', 'Arnhemon VV'] },
      { level: 2, name: 'Eerste Divisie', totalClubs: 20, promoted: 3, relegated: 3,
        rivals: ['De Graafstad', 'Roda Noord', 'MVV Maasstad', 'Almere FC', 'NAC Brendam', 'FC Eindhovense', 'SC Maasluison'] },
  ...
  'Бельгия': {
    ...
    leagues: [
      { level: 1, name: 'Jupiler Pro League', totalClubs: 16, promoted: 0, relegated: 2,
        rivals: ['Westvlaanderon', 'Bruxellois FC', 'Gentino', 'Unionville SC', 'Wallonion SC', 'Scheldion FC', 'Mechelois'] },
      { level: 2, name: 'Challenger Pro League', totalClubs: 8, promoted: 2, relegated: 2,
        rivals: ['OH Leuvenis', 'Anverzon FC', 'FC Deinzam', 'Molenbeekon FC', 'Liersam', 'Virtonol', 'Lommel FC'] },
      { level: 3, name: 'Eerste nationale', totalClubs: 16, promoted: 2, relegated: 3,
        rivals: ['Hoeselt VC', 'Mandel FC', 'SC Liègeon', 'SK Londerzol', 'UR Namurois', 'CS Viséen', 'Patro Eisdeno'] },
  ...
  'Турция': {
    ...
    leagues: [
      { level: 1, name: 'Süper Lig', totalClubs: 18, promoted: 0, relegated: 3,
        rivals: ['Boğazşar', 'Kadıköyşar', 'Çelikşar', 'Karadenizşar', 'Şehirşar FK', 'Kızılirmakşar', 'Ovaşar FK'] },
      ...
      { level: 4, name: '3. Lig', totalClubs: 24, promoted: 2, relegated: 0,
        rivals: ['Serhat FK', 'Erzinia', 'Bayramşar SK', 'Kırşehirşar', 'Hacişar', 'Güneşşar FK', 'Yomraşar'] },
    ],
  },
  ...
  'Греция': {
    ...
    leagues: [
      { level: 1, name: 'Super League 1', totalClubs: 16, promoted: 0, relegated: 3,
        rivals: ['Piraionikos', 'Salonikonnikos', 'Athinonikos', 'Leukosikos', 'Agonikos', 'Atromitikos', 'Asterion Tripolis'] },
  ...
  'Швейцария': {
    ...
    leagues: [
      ...
      { level: 4, name: '1. Liga', totalClubs: 20, promoted: 2, relegated: 0,
        rivals: ['FC Locarnol', 'FC Könizol', 'SV Muriol', 'FC Rheintalol', 'Kosova Zürichol', 'FC Weesenol', 'FC Zuchwilol'] },
    ],
  },
  ...
  'Украина': {
    ...
    leagues: [
      ...
      { level: 2, name: 'Перша ліга', totalClubs: 16, promoted: 2, relegated: 3,
        rivals: ['Опришок', 'Волинець', 'Закарпатик', 'Буковинець', 'Гуцульник', 'Дунаєць', 'Збручець'] },
      ...
      { level: 4, name: 'Третя ліга', totalClubs: 24, promoted: 2, relegated: 0,
        rivals: ['Тернопілець', 'Рівненець', 'Хмельничанин', 'Збаражець', 'Горинець', 'Прутець', 'Синюхець'] },
    ],
  },
  ...
  'Хорватия': {
    ...
    leagues: [
      ...
      { level: 4, name: '3. NL', totalClubs: 16, promoted: 2, relegated: 0,
        rivals: ['NK Zelinol', 'NK Virovitol', 'NK Knínol', 'NK Bjelovarol', 'NK Koprivnicol', 'NK Solinol', 'NK Dugavol'] },
    ],
  },
  ...
  'Япония': {
    ...
    leagues: [
      { level: 1, name: 'J1 League', totalClubs: 18, promoted: 0, relegated: 3,
        rivals: ['Tamagawon FC', 'Saitamon FC', 'Naniwaon FC', 'Minatogawaon FC', 'Chukyon FC', 'Sakuranon FC', 'Rokkon FC'] },
      { level: 2, name: 'J2 League', totalClubs: 22, promoted: 3, relegated: 3,
        rivals: ['Enshunon FC', 'Rikuchunon FC', 'Michinokun FC', 'Miyakon FC', 'Gifuon FC', 'Hokkaion FC', 'Iyon FC'] },
      { level: 3, name: 'J3 League', totalClubs: 20, promoted: 3, relegated: 3,
        rivals: ['SC Sagamiharaon', 'Fujiedaon FC', 'Numazu Aolon', 'Osakaron FC', 'Tottorion FC', 'Hachinohe Weston', 'Imabaron FC'] },
      { level: 4, name: 'JFL', totalClubs: 16, promoted: 2, relegated: 0,
        rivals: ['Suzukaon FC', 'Mieton FC', 'Tosan FC', 'Kamuiton FC', 'Owaron FC', 'Komanon FC', 'Settsuon FC'] },
    ],
  },
  ...
  'Южная Корея': {
    ...
    leagues: [
      ...
      { level: 3, name: 'K3 League', totalClubs: 16, promoted: 3, relegated: 3,
        rivals: ['Cheonan City FC', 'Hwaseong FC', 'FC Ansanon', 'Pyeongtaek Citiz', 'Gimpo FC', 'Daejeonon FC', 'Incheonon FC'] },
      { level: 4, name: 'K4 League', totalClubs: 16, promoted: 2, relegated: 0,
        rivals: ['Suncheonon FC', 'Yeosuon FC', 'Chuncheonon FC', 'Gyeongjuon FC', 'Tamnaon FC', 'Palgongon FC', 'Hwaseongon FC'] },
    ],
  },
  ...
  'Китай': {
    ...
    leagues: [
      { level: 1, name: 'Super League', totalClubs: 16, promoted: 0, relegated: 3,
        rivals: ['Shanghailon FC', 'Jiangsulon FC', 'Guangzhoulon FC', 'Beijinglon FC', 'Shandongulon FC', 'Wuhanlon FC', 'Tianjinlon FC'] },
      { level: 2, name: 'China League One', totalClubs: 16, promoted: 3, relegated: 3,
        rivals: ['Zhejianglon FC', 'Qingdaolon FC', 'Chongqinglon FC', 'Dalianlon FC', 'Yanbianlon FC', 'Meizhoulon FC', 'Nanjinglon FC'] },
      { level: 3, name: 'China League Two', totalClubs: 16, promoted: 3, relegated: 3,
        rivals: ['Henanlon FC', 'Chengdulon FC', 'Guangxilon FC', 'Guizhoulon FC', 'Xinjianglon FC', 'Ningbolon FC', 'Shaanxilon FC'] },
      { level: 4, name: 'China Amateur League', totalClubs: 20, promoted: 2, relegated: 0,
        rivals: ['Hunanlon FC', 'Jilinlon FC', 'Heilongjianglon FC', 'Gansulon FC', 'Yunnanlon FC', 'Hainanlon FC', 'Shanxilon FC'] },
    ],
  },
  ...
  'Саудовская Аравия': {
    ...
    leagues: [
      { level: 1, name: 'Pro League', totalClubs: 18, promoted: 0, relegated: 3,
        rivals: ['Al Nujumon', 'Al Mansouron FC', 'Al Wihdaton', 'Al Wifaqon', 'Al Farisyon', 'Al Qadison', 'Al Tawunon'] },
      { level: 2, name: 'First Division', totalClubs: 16, promoted: 2, relegated: 3,
        rivals: ['Al Faisalon', 'Al Hazemon', 'Al Damacon', 'Al Ittifaqon', 'Al Fayhaon', 'Al Adalon', 'Al Batinon'] },
      { level: 3, name: 'Second Division', totalClubs: 16, promoted: 3, relegated: 3,
        rivals: ['Al Ohodion', 'Al Qamaruon', 'Al Abhaon', 'Al Orubahon', 'Al Riyadhon', 'Al Jandalon', 'Al Rawdahon'] },
      { level: 4, name: 'Third Division', totalClubs: 20, promoted: 2, relegated: 0,
        rivals: ['Al Watanion', 'Al Ansaron', 'Al Kholoudon', 'Al Nahdaon', 'Al Hejazon', 'Al Salamuon', 'Al Khalijuon'] },
    ],
  },
  ...
  'Колумбия': {
    ...
    leagues: [
      { level: 1, name: 'Liga BetPlay', totalClubs: 20, promoted: 0, relegated: 2,
        rivals: ['Doradón FC', 'Valleco FC', 'Verdilón', 'Caribeño FC', 'Bogotón FC', 'Caucaño FC', 'Caldenseño FC'] },
      { level: 2, name: 'Dimayor B', totalClubs: 14, promoted: 2, relegated: 2,
        rivals: ['Tuluaón FC', 'Llaneron FC', 'Felínesco', 'Cartagenón FC', 'Guajirón FC', 'Palmiranón FC', 'Cafetalón FC'] },
      { level: 3, name: 'Primera B', totalClubs: 16, promoted: 3, relegated: 3,
        rivals: ['Cúcutón Dep', 'Calicañón', 'Magdanón FC', 'Tunjañón FC', 'Petronerón FC', 'Ciclónico', 'Rionegrón FC'] },
      { level: 4, name: 'Liga Regional', totalClubs: 24, promoted: 2, relegated: 0,
        rivals: ['Líbanón FC', 'Metanón FC', 'Caldanón FC', 'Nariñón FC', 'Araucón FC', 'Llancón FC', 'Nariñatón FC'] },
    ],
  },
