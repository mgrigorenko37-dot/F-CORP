...
const ROLES: string[] = [
  ...
  'Ассистент тренера','Ассистент тренера',
  'Тренер по атаке','Тренер по обороне','Тренер по тактике',
  'Тренер вратарей','Тренер вратарей',
  'Тренер по физподготовке','Тренер по физподготовке',
  'Специалист по восстановлению','Диетолог',
  'Главный врач','Физиотерапевт','Физиотерапевт',
  'Главный аналитик','Видеоаналитик','Аналитик данных',
  'Директор скаутинга','Скаут','Скаут','Скаут',
];
